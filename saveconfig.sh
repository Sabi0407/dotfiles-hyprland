...
DIRS=(aliases flameshot fastfetch gtk-3.0 gtk-4.0 hypr kitty Kvantum Mousepad mpv nerdfetch nwg-look qt5ct Scripts spicetify swaync Thunar wal waybar tofi micro yazi zathura waypaper)
